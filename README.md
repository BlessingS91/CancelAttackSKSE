...
A lightweight SKSE plugin that allows the player to cancel attacks.
...
```
git clone --recurse-submodules -j8 https://github.com/gabriel-andreescu/CancelAttackSKSE.git
cd CancelAttackSKSE
...
```
Data/SKSE/Plugins/CancelAttackSKSE.ini
```
